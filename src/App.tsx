    ...
    <div className="bg-gray-900 min-h-screen text-white font-sans">
      ...
      <nav className="py-4 bg-gradient-to-r from-purple-600 to-red-500">
        <div className="container mx-auto flex items-center justify-between px-4">
          <div className="flex items-center bg-white rounded-full px-4 py-2 shadow-lg"> {/* Added white background, padding, and shadow */}
            <Headphones size={32} color="black" /> {/* Changed icon color to black */}
            <span className="text-black text-3xl font-black ml-2">MuzixGo</span> {/* Changed text color to black, increased size, and made bolder */}
          </div>
